...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username') displayInfo=true; section>
    <#if section = "form">
        <form class="triphosts-form" action="${url.loginAction}" method="post">
            <div class="triphosts-field">
                ...
                <input type="text" id="username" name="username" class="triphosts-input" 
            ...
            <input class="triphosts-button" type="submit" value="${msg("doSubmit")}"/>
        </form>
        
        <div style="text-align: center; margin-top: 24px;">
            <a href="${url.loginUrl}" class="triphosts-link">
                ${msg("backToLogin")}
            </a>
        </div>
    <#elseif section = "info">
        <div style="text-align: center;">
            <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; border-radius: 8px; margin-bottom: 16px;">
                ...
                <p style="color: #92400e; font-size: 14px; line-height: 1.5;">
                    Vamos te ajudar a voltar para suas aventuras em instantes
                </p>
            </div>
            ...
            <div style="background: #f0f9ff; border: 1px solid #0284c7; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
                    ...
                    <span style="color: #0369a1; font-weight: 600; font-size: 14px;">Processo seguro e protegido</span>
                </div>
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
                    <span style="color: #0284c7; font-size: 18px;">⚡</span>
                    <span style="color: #0369a1; font-weight: 600; font-size: 14px;">Redefinição rápida e fácil</span>
                </div>
                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
                    <span style="color: #0284c7; font-size: 18px;">📧</span>
                    <span style="color: #0369a1; font-weight: 600; font-size: 14px;">Instruções claras por email</span>
                </div>
                <div style="display: flex; align-items: center; gap: 8px;">
                    <span style="color: #0284c7; font-size: 18px;">🌍</span>
                    <span style="color: #0369a1; font-weight: 600; font-size: 14px;">Suas viagens te esperam</span>
                </div>
            </div>
        </div>
    </#if>
